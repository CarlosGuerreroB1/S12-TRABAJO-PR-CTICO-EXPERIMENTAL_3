...
class DetectionSession(models.Model):
    """Sesión de detección iniciada por el usuario."""
    ...
    def __str__(self):
        return f"Sesión #{self.pk} - {self.get_detection_type_display()} ({self.started_at:%d/%m/%Y %H:%M})"


class DetectionEvent(models.Model):
    """Evento individual de detección capturado."""
